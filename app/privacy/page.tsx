...
export default function PrivacyPage() {
  return <InfoPage title="Privacy" description={`Privacy information for ${site.siteName}. Updated ${site.informationUpdated}.`}>
    ...
    <p>We store your analytics preference locally so it can be respected. A separate <code>guide-analytics-excluded</code> browser setting is used to exclude the maintainer’s test visits. It contains an on/off value, not an account identifier. Local and preview domains do not send analytics through this site’s loader.</p>
